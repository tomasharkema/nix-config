...
in with lib; {
  ...
  config = {
    ...
    home = {
      ...
      sessionVariables = if stdenv.isDarwin then {
        EDITOR = "subl";
    ...
    programs = {
      ...
      atuin = {
        ...
        settings = {
          ...
          secrets_filter = true;
          common_subcommands =
            [ "cargo" "go" "git" "npm" "yarn" "pnpm" "kubectl" "nix" "nom" ];
        };
      };
      ...
      zsh = {
        ...
        shellAliases = {
          ...
          gs = "git status";
          pvzst =
            "pv @1 -N in -B 500M -pterbT | zstd - -e -T4 | pv -N out -B 500M -pterbT > @2";
          cat = "bat";
          dig = "dog";
          ...
          dockerlogin =
            "op item get raeclwvdys3epkmc5zthv4pdha --format=json --vault=qtvfhvfotoqynomh2wd3yzoofe | jq '.fields[1].value' -r | docker login ghcr.io --username tomasharkema --password-stdin";
