    ...
    config = {
      ...
      boot = {
        ...
        in
          ...
          then mkDefault (pkgs.linuxPackagesFor linuxPackages_latest_kernel_cached) # pkgs.linuxPackages_latest
          else mkDefault (pkgs.linuxPackagesFor linuxPackages_cachyos_kernel_cached); # pkgs.linuxPackages_cachyos;
