{ lib, stdenv, fetchFromGitHub, autoconf, automake, cargo, libtool, pkg-config
...
, withNetSnmp ? true, krb5, pcre2, python3, rustPlatform, rustc, openssl
...
stdenv.mkDerivation rec {
  ...
  cargoDeps = rustPlatform.fetchCargoTarball {
    ...
    name = "${pname}-${version}";
    hash = "sha256-aa+IXDfeomSB/+C8CbVzL9iLVg2KVNrp7eAbmqq5P7g=";
  };

  nativeBuildInputs =
    [ autoconf automake libtool pkg-config python3 cargo rustc ]
