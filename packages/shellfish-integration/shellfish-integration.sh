...
EOF
    ...
    exiftool -v 1>/dev/null 2>/dev/null || {
...
EOF
  ...
  local key=5a561e15b205a69133497ee6d2591b2536375f924efb63578de243cabc86a3cd
  local user=CF6qwNVEPy5fth020CznwkUvJfY9Li1rt7wCAjkB
