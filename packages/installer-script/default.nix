{
  ...
  diskoScripts =
    lib.attrsets.concatMapAttrs (
      name: value:
      # builtins.trace "diskoScripts installer-configuration ${name}"
      # (
        if
          ((!(lib.strings.hasInfix "installer" name))
  ...
  diskoMountScripts =
    lib.attrsets.concatMapAttrs (
      name: value:
      # builtins.trace "diskoMountScripts installer-configuration ${name}"
      # (
        if
          ((!(lib.strings.hasInfix "installer" name))
            && ((builtins.hasAttr "_module" value)
