...
{fetchNuGet}: [
  ...
  (fetchNuGet {
    ...
    version = "2.0.0-rc3.3";
    hash = "sha256-O4uOjWhpZtRkxGOEtmMFfIxXxjW0zeUiEb7nvI7KvNw=";
  })
  (fetchNuGet {
    pname = "LiveChartsCore.SkiaSharpView";
    version = "2.0.0-rc3.3";
    hash = "sha256-aLCZsa8zRXrL0VwCCPgA4l7S5MpNwRcjcm50uJmdfgk=";
  })
  (fetchNuGet {
    pname = "LiveChartsCore.SkiaSharpView.Avalonia";
    version = "2.0.0-rc3.3";
    hash = "sha256-SnqwnzdjgByNmFhOcMfnHhC0F86qT0QHXY6vd0lNuEo=";
  })
  (fetchNuGet {
