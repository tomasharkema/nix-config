...
in
  stdenv.mkDerivation (finalAttrs: {
    ...
    installPhase = ''
      ...
      cp polkit-1/com.anydesk.anydesk.policy $out/share/polkit-1/actions/com.anydesk.anydesk.policy
    ...
    postFixup = ''
      ...
      substituteInPlace $out/lib/systemd/system/anydesk.service \
         --replace "ExecStart=/usr/bin/anydesk" "ExecStart=$out/bin/anydesk"
    '';
